...
public class LnkToExe {
    ...
    private static string GetTruePath(string path) {
        ...
        if (path.Length > 25 && path.Substring(0, 23) == GetSystemRoot() + @"Program Files (x86)\") {
            string path_end = path.Substring(23);
            s64 = GetSystemRoot() + @"Program Files\" + path_end;
            s32 = GetSystemRoot() + @"Program Files (x86)\" + path_end;
        }
        else if (path.Length > 20 && path.Substring(0, 17) == GetSystemRoot() + @"Program Files\") {
