...
class Menu {
    ...
    constructor(M: MainWindow) {
         ...
         * @param _css 
         */
        function openDropDown(_domMenu: HTMLElement | null, _domBtn: HTMLElement | null, _css: string) {
         ...
         * 開啟 - 滑鼠右鍵
         */
        function openRightClick(_domMenu: HTMLElement) {
         ...
         * 開啟 - 原地
         */
        function openOrigin(_domMenu: HTMLElement) {
